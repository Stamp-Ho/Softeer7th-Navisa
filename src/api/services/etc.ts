...
import type {
  ...
  PatchFormStatusRequest,
  PatchFormStatusResponse,
...
export const visaService = {
  ...
  patchFormStatus: (
    api: apiClientType,
    formId: string,
    data: PatchFormStatusRequest,
  ) =>
    api.patch<BaseResponse<PatchFormStatusResponse>>(
      `/api/application-forms/${formId}/status`,
      data,
    ),
};
...
export interface PatchStatusFinishedResponse {
