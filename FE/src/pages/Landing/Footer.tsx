          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm text-right">
            <div>
              ...
              <ul className="space-y-2">
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.aboutVisa")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.visaProcedure")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.eVisa")}
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.category.attorneyTerms")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.category.attorneyInquiry")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.category.ourAttorneys")}
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.support.faq")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.support.embassyGuide")}
                </li>
                <li className="hover:text-white cursor-pointer transition" tabIndex={0}>
                  {t("landing.support.inquiry")}
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-xs space-y-1">
            ...
            <div className="flex gap-4">
              <span className="hover:underline cursor-pointer" tabIndex={0}>
                {t("landing.footer.terms")}
              </span>
              <span className="hover:underline cursor-pointer text-white font-medium" tabIndex={0}>
          ...
          <div className="flex items-center gap-2 bg-gray-800/50 px-4 py-2 rounded-full border border-gray-700">
            <span className="text-[10px] uppercase font-bold tracking-widest mr-2">
              {t("landing.footer.topDestinations")}
            </span>
